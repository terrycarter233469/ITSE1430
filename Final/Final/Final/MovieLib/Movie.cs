...
namespace MovieLib
{
    ...
    public class Movie : IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate ( ValidationContext validationContext )
        {
            ...
            if (Title.Length < 2 || Title.Length > 100) //Terry Carter. Added validation to title for length between 2 to 100 characters. CR4
                yield return new ValidationResult("Please specify a title between 2 and 100 characters in length", new[] { "Title" });
