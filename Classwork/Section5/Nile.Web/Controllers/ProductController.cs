...
namespace Nile.Web.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ActionResult Edit(int id)
        {
            ...
            if (product == null)
                return HttpNotFound(); //triggers a 404
        ...
        {
            var products = _database.GetAll(); //get the data
            return View(products.ToModel()); //converts the data to a model using an extension method
        }
